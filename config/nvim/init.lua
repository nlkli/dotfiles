...
local function applyRecol()
    ...
    local P = {
        black       = { "#252530", "#252530", "#1f1f29" },
        red         = { "#d8647e", "#d8647e", "#b8556b" },
        green       = { "#7fa563", "#7fa563", "#6c8c54" },
        yellow      = { "#f3be7c", "#f3be7c", "#cfa269" },
        blue        = { "#6e94b2", "#6e94b2", "#5e7e97" },
        magenta     = { "#bb9dbd", "#bb9dbd", "#9f85a1" },
        cyan        = { "#aeaed1", "#aeaed1", "#9494b2" },
        white       = { "#cdcdcd", "#cdcdcd", "#aeaeae" },
        orange      = { "#e6917d", "#e6917d", "#c37b6a" },
        pink        = { "#d399a6", "#d399a6", "#b3828d" },
        bg          = { "#0a0a0a", "#141415", "#232324", "#313134", "#4c4c50" },
        fg          = { "#dcdcdc", "#cdcdcd", "#929292", "#5d5d5d" },
        sel         = { "#303031", "#404041" },
        cur         = {
            bg = "#cdcdcd",
            fg = "#141415",
