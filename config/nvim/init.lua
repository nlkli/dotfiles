...
--------------------------
-- Keyboard layout (Russian layout support via langmap)
--------------------------
vim.opt.langmap =
...
local function applyRecolTheme()
    ...
    local P = {
        black       = { "#324a4d", "#47686c", "#516568" },
        red         = { "#e66533", "#e97749", "#ea7c52" },
        green       = { "#49e9a6", "#60ebb1", "#64ecb3" },
        yellow      = { "#e4b781", "#e69533", "#e8c294" },
        blue        = { "#49ace9", "#60b6eb", "#64b8ec" },
        magenta     = { "#df769b", "#e798b3", "#e48baa" },
        cyan        = { "#49d6e9", "#60dbeb", "#64dcec" },
        white       = { "#b2cacd", "#c1d4d7", "#bed2d5" },
        orange      = { "#e58e5a", "#e8863e", "#e99f73" },
        pink        = { "#cc9880", "#d5a690", "#d4a793" },
        bg          = { "#020a0c", "#031417", "#052126", "#072f36", "#0b4752" },
        fg          = { "#bfd9dc", "#b2cacd", "#7f9092", "#515b5d" },
        sel         = { "#1d2f32", "#1d2f32" },
        cur         = {
            bg = "#b2cacd",
            fg = "#031417",
