...
local function applyRecol()
    ...
    local P = {
        black   = { "#d6d6d6", "#d6d6d6", "#b6b6b6" },
        red     = { "#874e42", "#874e42", "#734238" },
        green   = { "#677940", "#677940", "#586736" },
        yellow  = { "#b89058", "#b89058", "#9c7a4b" },
        blue    = { "#8ba1bf", "#8ba1bf", "#7689a2" },
        magenta = { "#aa759f", "#aa759f", "#916387" },
        cyan    = { "#3e5f66", "#3e5f66", "#355157" },
        white   = { "#151515", "#151515", "#121212" },
        orange  = { "#a06f4d", "#a06f4d", "#885e41" },
        pink    = { "#4e322c", "#4e322c", "#422a25" },
        bg = { "#ececec", "#e1e1e1", "#d2d2d2", "#c2c2c2", "#a6a6a6" },
        fg = { "#060606", "#151515", "#505050", "#858585" },
        sel = { "#c2c2c2", "#b0b0b0" },
        cur = { 
            bg = "#151515",
            fg = "#d0d0d0",
