...
vim.keymap.set("n", "<leader>Ку", ":restart<CR>")
        ...
        for _, path in ipairs(files) do
            ...
            if stat then
                ...
                if stat.type == "directory" then
                    ...
                    size = string.format("%.1fK", stat.size / 1024)
                end
...
local function applyRecol()
    ...
    local P = {
        black       = { "#14171d", "#14171d", "#111419" },
        red         = { "#c4746e", "#c4746e", "#a7635e" },
        green       = { "#8a9a7b", "#8a9a7b", "#758369" },
        yellow      = { "#c4b28a", "#c4b28a", "#a79775" },
        blue        = { "#8ba4b0", "#8ba4b0", "#768b96" },
        magenta     = { "#a292a3", "#a292a3", "#8a7c8b" },
        cyan        = { "#8ea4a2", "#8ea4a2", "#798b8a" },
        white       = { "#c8c093", "#c8c093", "#aaa37d" },
        orange      = { "#c4937c", "#c4937c", "#a77d69" },
        pink        = { "#c69a81", "#c69a81", "#a8836d" },
        bg          = { "#0c0e12", "#14171d", "#1f232c", "#292f3c", "#3c4658" },
        fg          = { "#d4d8d6", "#c5c9c7", "#8c8e8d", "#575958" },
        sel         = { "#2f3237", "#3e4246" },
        cur         = {
            bg = "#c5c9c7",
            fg = "#14171d",
