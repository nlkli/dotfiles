...
local function applyRecol()
    ...
    local P = {
        black   = { "#2e3436", "#2e3436", "#272c2e" },
        red     = { "#cc0000", "#cc0000", "#ad0000" },
        green   = { "#4e9a06", "#4e9a06", "#428305" },
        yellow  = { "#c4a000", "#c4a000", "#a78800" },
        blue    = { "#3465a4", "#3465a4", "#2c568b" },
        magenta = { "#75507b", "#75507b", "#634469" },
        cyan    = { "#06989a", "#06989a", "#058183" },
        white   = { "#d3d7cf", "#d3d7cf", "#b3b7b0" },
        orange  = { "#c85000", "#c85000", "#aa4400" },
        pink    = { "#d06c68", "#d06c68", "#b05b58" },
        bg = { "#25081c", "#300a24", "#3f0d2f", "#4f103b", "#6b1650" },
        fg = { "#dfdfdd", "#eeeeec", "#b3b3b2", "#7e7e7d" },
        sel = { "#4d2c42", "#513448" },
        cur = { 
            bg = "#bbbbbb",
            fg = "#ffffff",
