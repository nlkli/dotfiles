...
local function applyRecol()
    ...
    local P = {
        black       = { "#282828", "#282828", "#222222" },
        red         = { "#cc241d", "#cc241d", "#ad1f19" },
        green       = { "#98971a", "#98971a", "#818016" },
        yellow      = { "#d79921", "#d79921", "#b7821c" },
        blue        = { "#458588", "#458588", "#3b7174" },
        magenta     = { "#b16286", "#b16286", "#965372" },
        cyan        = { "#689d6a", "#689d6a", "#58855a" },
        white       = { "#a89984", "#a89984", "#8f8270" },
        orange      = { "#d25f1f", "#d25f1f", "#b2501a" },
        pink        = { "#ba5f51", "#ba5f51", "#9e5044" },
        bg          = { "#1d1d1d", "#282828", "#373737", "#474747", "#636363" },
        fg          = { "#fae9be", "#ebdbb2", "#b0a486", "#7b725d" },
        sel         = { "#45433d", "#575349" },
        cur         = {
            bg = "#ebdbb2",
            fg = "#282828",
